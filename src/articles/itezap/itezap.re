...
化合物の性質に関わる重要な部分構造情報をビット列として表現するため、高速な類似度検索が可能になり、未知の化合物の機能推定などに役立ちます。
...
//tabooular[dataset][使用した化合物データセットの一覧。化合物は香りの含有量の降順で表記。]{
順位	|	バラ	&	イチゴ
==========>|====&====
1位	|	3314	|	11007913
2位	|	27866	|	643941
...
これは12180がイチゴといった果実特有の香りであるためであると考えられます。
このことから、類似している部分がありつつもお互い個性が光る部分もしっかりある、ということになります。
...
次の夏コミは五輪の関係でGW開催なので早めにネタを考えないといけないですね（無事受かれば、の話ですが）。
それでは、次の記事でお会いしましょう。
